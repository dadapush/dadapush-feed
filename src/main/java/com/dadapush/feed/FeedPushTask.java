...
public class FeedPushTask implements Runnable {
  ...
  private void init() throws URISyntaxException, SQLException {
    ...
    queryRunner.execute("ALTER TABLE feed_cache ALTER COLUMN title VARCHAR ( 1000 ) NOT NULL ;");
    queryRunner
        .execute("ALTER TABLE feed_cache ALTER COLUMN url VARCHAR ( 1000 ) NOT NULL ;");
  }
